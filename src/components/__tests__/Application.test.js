...
describe("Appointment", () => {
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    // 3. Click the "Delete" button on the appointment with Archie.
    ...
    // 4. Verify that clicking delete sends us to confirmation screen.
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => getByText(appointment, "There was an error while saving."));
  ...
  it("shows the delete error when failing to delete an existing appointment", async () => {
    ...
    await waitForElement(() => getByText(container, "1pm"));
    ...
    await waitForElement(() => getByText(appointment, "There was an error while deleting."));
